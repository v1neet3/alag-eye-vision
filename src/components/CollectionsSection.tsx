        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-xl text-gray-300 mb-8">
              ...
              aलg showcases creativity and innovation. Dive into a world where art meets individuality and explore 
